...
function UI:render()
    ...
    table.insert(texts, "Light: " .. tostring(data.env.value) .. "%")
    table.insert(texts, "Spawning: " .. tostring(data.spawnSprinters))

    table.insert(texts, "-----")
    table.insert(texts, "Base Light: " .. tostring(data.env.light) .. "%")
    table.insert(texts, "Fog: " .. tostring(data.env.fog) .. "%")
    table.insert(texts, "Light: " .. tostring(data.env.value) .. "%")
